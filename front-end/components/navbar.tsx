...
export const Navbar = () => {
	...
	return (
		<NextUINavbar maxWidth="xl" position="sticky" className="fixed border-b-[0.5px] border-gray-600 shadow-sm rou">
			...
			>
				...
				<NavbarItem className="hidden sm:flex gap-5 md:mr-10">
					<NextLink href="/login">
					<button className=' rounded-full py-2 px-5 text-black dark:text-white font-medium'> Log In</button>
					</NextLink>
					<NextLink href="/signup">
					<button className=' hover:bg-indigo-800 bg-indigo-500 rounded-lg py-2 px-5 text-white font-medium' >Sign Up</button>
					</NextLink>
					<ThemeSwitch />
				</NavbarItem>
			...
			<NavbarMenu>
				...
				<div className="mx-4 mt-2 flex flex-col gap-2">
					...
					<button 
					onClick ={handleLogout}
					className=' py-2  text-red-500  font-medium text-start '
